...
The transfer is concrete because NLAP now has finite graphs to run it on: for the Misiurewicz class, the exact-type catalogue of round-one B6, built on 2026-09-16, gives a finite set of ray addresses per `(l,k)`, and the extractor runs on them (`NLAP: d8dfa45`).
