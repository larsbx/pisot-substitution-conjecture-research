...
generated by `scripts/make_ledger.py` from the proof records it tabulates
(`tla/ledger.json`); change the table and regenerate, never the outputs. The claim ledger in
